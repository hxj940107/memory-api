...
export function buildHistoryPromptMessages(history = [], { cacheEnabled = true } = {}) {
  ...
  messages[lastIndex] = {
    ...
    content: [{
      type: "text",
      text: String(messages[lastIndex].content || ""),
...
export function buildCachedPromptMessages({
  ...
  return [
    stablePrefix,
    ...buildHistoryPromptMessages(history, { cacheEnabled: historyCacheEnabled }),
    {
      role: "system",
