...
import { isOwnedFreshEmptyMode } from "./memoryAuthority.js"
...
export function buildFreshEmptyCoreMemoryState() {
  return Object.freeze({
    snapshot: "",
    hash: hashCoreMemorySnapshot(""),
    createdAt: null,
    sourceBucketIds: Object.freeze([]),
    authorityMode: "owned_fresh_empty",
    empty: true,
  })
}
...
export async function ensureCoreMemorySnapshot({
  ...
  if (isOwnedFreshEmptyMode(authorityMode)) {
    ...
    return buildFreshEmptyCoreMemoryState()
  }
