  ...
  return {
    ...
    telemetry: {
      ...
      trace: {
        ...
        admission_rejected: (retrieval.trace?.compatibility_rejections || []).map(item => ({ memory_id: item.memory_id, stage: "semantic_admission_rejected", reason_codes: item.reason_codes })),
