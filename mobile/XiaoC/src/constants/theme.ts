...
export const XiaoCColors = {
  ...
  userVoiceTranscript: dynamicColor('rgba(74,158,255,0.13)', 'rgba(74,158,255,0.20)'),
  userVoiceTranscriptText: dynamicColor('#416D98', '#C5DCF5'),
  assistantVoiceTranscript: dynamicColor('rgba(118,118,128,0.10)', 'rgba(255,255,255,0.07)'),
  assistantVoiceTranscriptText: dynamicColor('#68686E', '#C2C2C7'),
  inputSurface: dynamicColor('#FFFFFF', 'rgba(44,44,46,0.72)'),
  inputBorder: dynamicColor('rgba(60,60,67,0.18)', 'rgba(255,255,255,0.12)'),
  voiceHoldRecording: dynamicColor('#D9DADD', '#3B3C40'),
  voiceHoldRecordingText: dynamicColor('#3F4044', '#F2F2F4'),
